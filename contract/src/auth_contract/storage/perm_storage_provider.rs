...
impl PermissionStorage for PermStorageProvider {
    ...
    async fn fetch_role(
        ...
        self.0.fetch_role(payload, option).await
    }

    async fn fetch_all_actor_roles(&self, actor_id: ArcUuid7) -> Result<Vec<Role>, anyhow::Error> {
        self.0.fetch_all_actor_roles(actor_id).await
    }
    ...
    async fn fetch_permission(
        ...
        self.0.fetch_permission(payload, option).await
    }
    ...
    async fn fetch_actor_role(
        ...
        self.0.fetch_actor_role(payload, option).await
    }
    ...
    async fn fetch_role_permission(
        ...
        self.0.fetch_role_permission(payload, option).await
    }
    ...
    async fn fetch_all_actor_session_permissions(
        ...
        self.0
            .fetch_all_actor_session_permissions(actor_id, active_role_id)
            .await
    }
}
