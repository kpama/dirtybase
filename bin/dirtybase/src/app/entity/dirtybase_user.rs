...
pub use dtos::*;
// pub use dirtybase_user_entity::LoggedInUser;
// pub use dirtybase_user_entity::UserLoginPayload;
...
pub const DIRTYBASE_USER_TABLE_LOGIN_ATTEMP_FIELD: &str = "login_attemp";
    ...
    if !manager.has_table(DIRTYBASE_USER_TABLE).await {
        manager
            .create_table_schema(DIRTYBASE_USER_TABLE, |table| {
                ...
                table
                    .integer(DIRTYBASE_USER_TABLE_LOGIN_ATTEMP_FIELD)
                    .set_default("0");
